<?php /*a:2:{s:50:"themes/admin_simpleboot3/admin\qyq\qyq_detail.html";i:1618471732;s:79:"D:\phpstudy_pro\WWW\dtz\cmf\public/themes/admin_simpleboot3/public\headers.html";i:1618471939;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    var app = new Vue({
        ...
        methods: {
            seach () {
                ...
                axios
                    .post('/api/qyq/getid_by_detail',{groupId: groupId})
            ...
            stop_qyq (start) {
                ...
                layer.confirm(msg, {
                    ...
                    axios
                        .post('/api/qyq/stop_qyq', {groupId: groupId,stat:start})
                        .then(function (response) {
            ...
            stop_dlm (start) {
                ...
                layer.confirm(msg, {
                    ...
                    axios
                        .post('/api/qyq/stop_dlm', {groupId: groupId,isCredit:start})
                        .then(function (response) {
                            if (response.data.code == 0) {
                                layer.msg(response.data.message);
                                vm.seach();
            ...
            zy_cy() {
                ...
                layer.confirm(msg, {
                    ...
                    axios
                        .post('/api/qyq/zy_cy', {fromGroupId: fromGroupId,fromUserId: fromUserId,toGroupId: toGroupId,toUserId: toUserId,})
                        .then(function (response) {
                            if (response.data.code == 0) {
                                layer.msg(response.data.message);
                            } else {
            ...
            move_qz() {
                ...
                layer.confirm('您确定要转换群主吗？', {
                    ...
                    axios
                        .post('/api/qyq/move_qz', {userId: userId, groupId: groupId})
                        .then(function (response) {
                            if (response.data.code == 0) {
                                layer.msg(response.data.message);
                                vm.is_newqz = false;
            ...
            up_max_number() {
                ...
                layer.confirm('您确定要修改最大人数吗？', {
                    ...
                    axios
                        .post('/api/qyq/up_max_number', {groupId: groupId, maxCount: maxCount})
                        .then(function (response) {
                            if (response.data.code == 0) {
                                layer.msg(response.data.message);
