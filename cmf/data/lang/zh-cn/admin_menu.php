...
return array (
  ...
  'ADMIN_JOURNAL_#' => '房钻管理',
  'ADMIN_JOURNAL_JOURNAL_LOG' => '发放记录',
  'ADMIN_JOURNAL_LIST_INFO' => '房钻管理',
  ...
  'ADMIN_QYQ_ADD_USER' => '账号注册',
  'ADMIN_QYQ_GET_QYQ_CYDATA' => '查询亲友圈成员数据',
  'ADMIN_QYQ_IP_CONFIG' => '托管管理',
  'ADMIN_QYQ_LIST_INFOS' => '小组数据',
  'ADMIN_QYQ_LIST_ONE_DATA' => '单组数据',
  'ADMIN_QYQ_QYQ_DETAIL' => '亲友圈资料',
  'ADMIN_QYQ_UP_BIND' => '修改绑定',
  'ADMIN_QYQ_UP_SHARES' => '修改成员占成',
  'ADMIN_QYQ_USER_INFOS' => '成员资料',
  ...
  'ADMIN_STATISTICS_#' => '数据统计',
  'ADMIN_STATISTICS_ADD_DATA' => '生成统计数据',
  'ADMIN_STATISTICS_DAILY_STAT' => '每日数据',
  'ADMIN_STATISTICS_DAILY_STAT_QYQ' => '亲友圈数据',
